...
import 'package:lushmkt_app/models/user_model.dart';
import 'package:lushmkt_app/repositories/auth_repository.dart';

class AuthController extends GetxController {
  final AuthRepository _repository = AuthRepository(Dio(BaseOptions(
    baseUrl: 'https://lushmkt.com/api/v1',
